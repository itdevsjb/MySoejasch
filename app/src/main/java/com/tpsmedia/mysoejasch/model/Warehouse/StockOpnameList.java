...
public class StockOpnameList {
    ...
    @SerializedName("data")
    @Expose
    private List<DatumStockOpnameList> data = null;

    public List<com.tpsmedia.mysoejasch.model.Warehouse.DatumStockOpnameList> getData() {
        return data;
    }
