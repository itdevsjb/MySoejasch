...
public class DetailStockoutList {
    ...
    @SerializedName("data")
    @Expose
    private List<Datumdetailstockout> data = null;

    public List<com.tpsmedia.mysoejasch.model.Warehouse.Datumdetailstockout> getData() {
        return data;
    }
