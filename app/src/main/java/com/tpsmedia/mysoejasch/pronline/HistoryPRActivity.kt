...
import com.tpsmedia.mysoejasch.databinding.ActivityPrhistoryBinding
...
class HistoryPRActivity : AppCompatActivity() {
    private lateinit var binding: ActivityPrhistoryBinding
    private lateinit var dbHelper: SQLiteHelper


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPrhistoryBinding.inflate(layoutInflater)
