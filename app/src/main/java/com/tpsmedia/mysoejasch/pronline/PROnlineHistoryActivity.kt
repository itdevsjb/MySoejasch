...
class PROnlineHistoryActivity : AppCompatActivity() {
    ...
    private fun initToolbar() {
        ...
        supportActionBar!!.title = "PR - History Approve"
    ...
    private fun getAllData(callback: (List<Datum>?) -> Unit) {
        val type = intent.getStringExtra("pr-activity");
        Thread {
            val dataList = dbHelper.getAllDataHistory(this, type)
            runOnUiThread {
                callback(dataList)
